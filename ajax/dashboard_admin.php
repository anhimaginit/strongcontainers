...
<div class="widget-body">
    ...
    <fieldset class="fs">
        ...
        <section>
            ...
            <div class="row">
                <div class="col col-2 p-r">
                    <label class="checkbox word-break">
                        <input type="checkbox" name="checkbox" class="pay-driver">
                        <i></i>PAY DRIVER
                    </label>
                </div>
                <div class="col col-2 p-r">
                    <label class="checkbox word-break">
                        <input type="checkbox" name="checkbox" class="pay-salesperson">
                        <i></i>PAY SALESPERSON</label>
                </div>
                <div class="col col-2 p-r">
                    <label class="checkbox word-break">
                        <input type="checkbox" name="checkbox" class="cancelled-status">
                        <i></i>CANCELLED</label>
                </div>
            </div>
        </section>
    ...
    <div id="order-report" class="p-t15 b-ground-w">
        ...
        <fieldset class="fs m-t10 m-b25 order-content task-cancelled" style="display:none">
        ...
        <fieldset class="fs m-t10 m-b25 order-content task-pay-driver" style="display:none">
        ...
        <fieldset class="fs m-t10 m-b25 order-content order-pay-sales" style="display:none">
            <input type="hidden" class="status-filter" value="paid_sales">
            <legend>PAY SALESPERSON</legend>
            <div class="row m-b5">
                <div class="col col-2">From date</div>
                <div class="col col-2">To date</div>
                <div class="col col-2">Text search</div>
