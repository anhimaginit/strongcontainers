...
<div id="order-report" class="p-t15 b-ground-w">
    ...
    <fieldset class="fs m-t10 m-b25 order-content task-open">
        ...
        <div class="row m-b5 search">
            ...
            <div class="col col-1">
                <button class="btn btn-sm btn-default btn-excell" id="exportExcelopen">Excel export </button>
            </div>
            <!--<div class="col col-1">
                <button class="btn btn-sm btn-default btn-pdf">PDF export </button>
            </div>-->
    ...
    <fieldset class="fs m-t10 m-b25 order-content task-progress">
        ...
        <div class="row m-b5 search">
            ...
            <div class="col col-1">
                <button class="btn btn-sm btn-default btn-excell" id="exportExcelprogress">Excel export </button>
            </div>
            <!--<div class="col col-1">
                <button class="btn btn-sm btn-default btn-pdf">PDF export </button>
            </div>-->
    ...
    <fieldset class="fs m-t10 m-b25 order-content task-pickup">
        ...
        <div class="row m-b5 search">
            ...
            <div class="col col-1">
                <button class="btn btn-sm btn-default btn-excell" id="exportExcelpickup">Excel export </button>
            </div>
            <!--<div class="col col-1">
                <button class="btn btn-sm btn-default btn-pdf">PDF export </button>
            </div>-->
    ...
    <fieldset class="fs m-t10 m-b25 order-content task-delivery" style="display:none">
        ...
        <div class="row m-b5 search">
            ...
            <div class="col col-1">
                <button class="btn btn-sm btn-default btn-excell" id="exportExceldelivery">Excel export </button>
            </div>
            <!--<div class="col col-1">
                <button class="btn btn-sm btn-default btn-pdf">PDF export </button>
            </div>-->
    ...
    <fieldset class="fs m-t10 m-b25 order-content task-close" style="display:none">
        ...
        <div class="row m-b5 search">
            ...
            <div class="col col-1">
                <button class="btn btn-sm btn-default btn-excell" id="exportExcelclose">Excel
                    export </button>
            </div>
            <!--<div class="col col-1">
                <button class="btn btn-sm btn-default btn-pdf">PDF export </button>
